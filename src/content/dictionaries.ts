...
export const dictionaries = {
  el: {
    ...
    home: {
      ...
      heroBody:
        "Η Margarita Paschali προσφέρει ατομικές συνεδρίες healing και ήπια καθοδήγηση για ανθρώπους που αναζητούν περισσότερη σύνδεση, γείωση και καθαρότητα στην καθημερινότητά τους.",
      ...
      aboutTitle: "Γνώρισε τη Margarita",
      aboutBody:
        "Με ήρεμη, ανθρώπινη προσέγγιση, η Margarita δημιουργεί χώρο για βαθύτερη ακρόαση, προσωπική φροντίδα και ουσιαστική αλλαγή.",
      healingTitle: "Ατομικές συνεδρίες healing",
      healingBody:
        "Μια συνεδρία αφιερωμένη σε εσένα, με καθαρή πρόθεση, πρακτική υποστήριξη και χώρο για όσα ζητούν προσοχή.",
    },
    about: {
      title: "Σχετικά με τη Margarita",
      body:
        "Η Margarita Paschali εργάζεται με ανθρώπους που θέλουν να νιώσουν ξανά πιο παρόντες, πιο ήρεμοι και πιο συνδεδεμένοι με την εσωτερική τους σοφία.",
      paragraphs: [
        ...
        "Το website ξεκινά με placeholder κείμενα εμπνευσμένα από τη δομή του reference site. Τα τελικά βιογραφικά, credentials και λεπτομέρειες πρακτικής μπορούν να αντικατασταθούν εύκολα από τα αρχεία content.",
      ],
    },
    healing: {
      title: "Healing",
      ...
      sections: [
        {
          ...
          body: "Κάθε συνεδρία προσαρμόζεται στις ανάγκες σου και μπορεί να περιλαμβάνει ήπια συζήτηση, ενεργειακή εργασία, reflection και πρακτικές γείωσης.",
        },
        {
