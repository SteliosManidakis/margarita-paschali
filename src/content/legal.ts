...
export const legalContent: Record<Locale, { terms: LegalPageContent; privacy: LegalPageContent }> = {
  el: {
    terms: {
      intro:
        "Οι παρόντες όροι περιγράφουν τη χρήση του website και των υπηρεσιών που παρέχονται από τη Margarita Paschali.",
      ...
      sections: [
        {
          ...
          body: [
            "Το website ανήκει στο προσωπικό brand Margarita Paschali. Για οποιαδήποτε ερώτηση σχετικά με το website ή τις υπηρεσίες, μπορείς να επικοινωνήσεις στο margaritapaschali@gmail.com.",
          ],
        },
        {
          title: "2. Βασικοί όροι",
          body: [
            "Οι λέξεις «εμείς», «μας» ή «η Margarita» αναφέρονται στη Margarita Paschali.",
        ...
        },
        {
          ...
          body: [
            "Το περιεχόμενο του website παρέχεται για ενημερωτικούς σκοπούς και για την παρουσίαση των υπηρεσιών της Margarita Paschali.",
        ...
        },
        {
          ...
          body: [
            ...
            "Το booking γίνεται μέσω Cal.com, όπου μπορείς να επιλέξεις διαθέσιμη ημερομηνία και ώρα. Μετά την κράτηση θα λάβεις email επιβεβαίωσης από την πλατφόρμα ή/και από τη Margarita.",
        ...
        },
        {
          ...
          body: [
            ...
            "Η Margarita διατηρεί το δικαίωμα να αρνηθεί ή να διακόψει συνεδρία σε περίπτωση επιθετικής, προσβλητικής, ανάρμοστης, σεξουαλικής, απειλητικής ή άλλης συμπεριφοράς που παραβιάζει το ασφαλές πλαίσιο συνεργασίας.",
          ],
        },
        {
    ...
    privacy: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            "Αν εγγραφείς στο newsletter, μπορείς να λαμβάνεις ενημερώσεις, νέα ή προσκλήσεις σχετικές με τη δουλειά της Margarita.",
