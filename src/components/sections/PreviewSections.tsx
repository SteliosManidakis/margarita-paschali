  ...
  return (
    <section className="bg-ivory py-20 sm:py-28">
      <Container className="grid gap-12 md:grid-cols-2 md:gap-16">
        <article>
          <div className="aspect-[4/5] overflow-hidden rounded-tl-[5rem]">
            <Image
          ...
          <h2 className="mt-8 font-serif text-4xl text-charcoal">{dictionary.home.aboutTitle}</h2>
        ...
        <article className="md:pt-20">
          <div className="aspect-[4/3] overflow-hidden rounded-br-[5rem]">
            <Image
          ...
          <h2 className="mt-8 font-serif text-4xl text-charcoal">{dictionary.home.healingTitle}</h2>
